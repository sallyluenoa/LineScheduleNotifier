...
/**
 * Interface for accessing general information data.
 */
interface GeneralInfoDataSource {
    /**
     * Fetches general information data for a specific month.
     *
     * @param yearMonth The year and month to fetch data for.
     * @return A list of rows, where each row is a list of cell values.
     */
    fun fetchMonthlyGeneralInfoData(yearMonth: YearMonth): List<List<Any>>
}
